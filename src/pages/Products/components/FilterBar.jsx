            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  onClick={() => dispatch({ type: "SORT_BY", payload: { sortBy: "lowtohigh" || false } })}
                />
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                  onClick={() => dispatch({ type: "SORT_BY", payload: { sortBy: "hightolow" || false } })}
                />
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  name="rating-sort"
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                  onClick={() => dispatch({ type: "RATINGS", payload: { ratings: "4STARSABOVE" || false } })}
                />
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                  onClick={() => dispatch({ type: "RATINGS", payload: { ratings: "3STARSABOVE" } || false })}
                />
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                  onClick={() => dispatch({ type: "RATINGS", payload: { ratings: "2STARSABOVE" } || false })}
                />
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                  onClick={() => dispatch({ type: "RATINGS", payload: { ratings: "1STARSABOVE" } || false })}
                />
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  onChange={() =>
                    dispatch({ type: "BEST_SELLER_ONLY", payload: { bestSellerOnly: !state.bestSellerOnly || false } })
                  }
                />
                <label htmlFor="best-seller" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                  Best Seller Only
                </label>
              </div>
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                  onChange={() =>
                    dispatch({ type: "ONLY_IN_STOCK", payload: { onlyInStock: !state.onlyInStock || false } })
                  }
                />
                <label htmlFor="only-instock" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                  INSTOCK Only
                </label>
              </div>
            </li>
